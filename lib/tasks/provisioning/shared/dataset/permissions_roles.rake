      ...
      namespace :permissions_roles do
        ...
        task populate: :environment do
          ...
          ActiveRecord::Base.connection.execute <<-SQL
            ...
            INSERT INTO permissions_roles (id, permission_id, role_id, created_at, updated_at) VALUES (7, 4, 2, '2022-05-12 16:27:30.019856', '2022-05-12 16:27:30.019856') ON CONFLICT DO NOTHING;  
            INSERT INTO permissions_roles (id, permission_id, role_id, created_at, updated_at) VALUES (8, 5, 2, '2022-05-12 16:27:30.019856', '2022-05-12 16:27:30.019856') ON CONFLICT DO NOTHING;      
          SQL
